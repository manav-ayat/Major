...
def uploaded_chest():
   ...
   if probability[0] > 0.5:
      resnet_chest_pred = str('% COVID') 
   else:
      resnet_chest_pred = str('% NonCOVID')
   ...
   if probability[0] > 0.5:
      inception_chest_pred = str('% COVID') 
   else:
      inception_chest_pred = str('% NonCOVID')
   ...
   if probability[0] > 0.5:
      xception_chest_pred = str('% COVID') 
   else:
      xception_chest_pred = str('% NonCOVID')
...
def uploaded_ct():
   ...
   print("Resnet Predictions:")
   if probability[0] > 0.5:
      resnet_ct_pred = str('% COVID') 
   else:
      resnet_ct_pred = str('% NonCOVID')
   ...
   print("VGG Predictions:")
   if probability[0] > 0.5:
      vgg_ct_pred = str('% COVID') 
   else:
      vgg_ct_pred = str('% NonCOVID')
   print(vgg_ct_pred)
   ...
   print("Inception Predictions:")
   if probability[0] > 0.5:
      inception_ct_pred = str('% COVID') 
   else:
      inception_ct_pred = str('% NonCOVID')
   ...
   print("Xception Predictions:")
   if probability[0] > 0.5:
      xception_ct_pred = str('% COVID') 
   else:
      xception_ct_pred = str('% NonCOVID')
